...
class _AddUnitState extends State<AddUnit> {
  ...
  Widget build(BuildContext context) {
    ...
    bool isRentTheEntireBuilding = BuildingType.rentTheEntireBuilding == widget.buildingType;
    bool isRentByUnit = BuildingType.rentByUnit == widget.buildingType;

    bool isRentTheEntireCompound = CompoundType.rentTheEntireCompound == widget.compoundType;
                            ...
                            child: Column(
                              children: [
                                ...
                                CustomElevatedButton(
                                  onPressed: () {
                                    AutoRouter.of(context).push(const UnitDetailsRoute());
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: const Center(
          child: Text('Your building has been added successfully!',
